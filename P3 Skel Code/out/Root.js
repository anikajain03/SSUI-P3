...
export class Root {
    ...
    // draws the child, and then restores the context.
    _redraw() {
        ...
        try {
            ...
            // loop through each child and draw
            for (const child of this._children) {
                // save context before drawing
                this.canvasContext.save();
                // translate to child's coordinate system
                this.canvasContext.translate(child.x, child.y);
                // call child's draw method
            ...
            Err.warning("Exception captured and suppressed during redraw.  Pressing ahead...");
        }
        finally {
